...
const groqPreferences = ["deepseek-r1-distill-llama-70b", "llama-3.3-70b-versatile", "mixtral-8x7b-32768"];
...
await describe("selectDefaultModel", async () => {
  await it("selects the highest priority model from the preference list", () => {
    ...
    const selected = selectDefaultModel(fetched, "fallback-default", groqPreferences);
