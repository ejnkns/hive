/** @public — the deterministic renderer: FlowBlueprint → TypeScript flow definition.
 ...
 * them *structurally* from a validated blueprint — so a rendered definition is
 ...
 *     alias derived from the blueprint's instanceState declaration;
