...
export const wayfinderBlueprint = {
  ...
  tools: [
    ...
    { id: "submit_spec", ref: "./tools/submit-spec.ts", writes: ["spec"] },
  ],
  operations: [
    {
      id: "settle_chart",
    ...
    { id: "finalize_spec", ref: "./build/ops/finalize-spec.ts" },
    { id: "persist_build_plan", ref: "./build/ops/persist-build-plan.ts" },
    {
      id: "prepare_build_workspace",
      ref: "./build/ops/prepare-build-workspace.ts",
    },
    { id: "merge_build_work", ref: "./build/ops/merge-build-work.ts" },
  ],
  workflows: [
    // ── charting: name the destination, surface the decision frontier ──
    {
      id: "charting",
      label: "Charting",
      description:
    ...
    // ── ticket: one decision per instance, claimed by type ──
    {
      id: "ticket",
      label: "Ticket",
      description:
      ...
      states: [
          ...
          actions: [
            {
              ...
              gate: {
                ...
                gates: [
                  ...
                  { kind: "file", ref: "./gates/blockers-closed.ts" },
                ],
              },
            ...
            },
            {
              ...
              gate: {
                kind: "and",
                gates: [
                  { kind: "instanceStateEquals", field: "type", value: "task" },
                  {
                    kind: "not",
                    gate: {
                      kind: "instanceStateEquals",
          ...
          autoTransitions: [
            {
              ...
              gate: {
                kind: "and",
                gates: [
                  { kind: "taskSuccess", task: "research" },
                  { kind: "taskSuccess", task: "persistFindings" },
                ],
              },
            },
          ],
          actions: [
            {
              ...
              variant: "secondary",
              gate: { kind: "taskError", task: "research" },
              transitionTo: "resolving_research",
            },
            {
              id: "cancel",
          ...
          autoTransitions: [
            {
              ...
              gate: {
                kind: "and",
                gates: [
                  { kind: "taskSuccess", task: "preparePrototype" },
                  { kind: "taskSuccess", task: "prototypeSession" },
                ],
              },
            },
            {
              to: "ready",
              gate: { kind: "taskError", task: "preparePrototype" },
            },
          ],
          actions: [
            {
        ...
        },
        {
          ...
          autoTransitions: [
            {
              to: "recording",
              gate: { kind: "taskSuccess", task: "grillSession" },
            },
          ],
          actions: [
            {
        ...
        },
        {
          ...
          autoTransitions: [
            {
              to: "recording",
              gate: { kind: "taskSuccess", task: "taskSession" },
            },
          ],
          actions: [
            {
              ...
              label: "Retry task",
              variant: "secondary",
              gate: { kind: "taskError", task: "taskSession" },
              transitionTo: "resolving_task",
            },
            {
              id: "cancel",
        ...
        },
        {
          ...
          autoTransitions: [
            {
              to: "recording",
              gate: { kind: "taskSuccess", task: "taskHitlSession" },
            },
          ],
          actions: [
            {
        ...
        },
        {
          ...
          autoTransitions: [
            {
              to: "closed",
              gate: { kind: "taskSuccess", task: "assembleResolution" },
            },
            {
              to: "ready",
              gate: { kind: "taskError", task: "assembleResolution" },
            },
          ],
        },
        {
    ...
    // ── build: spec the collapsed decisions, plan tracer bullets ──
    {
      id: "build",
      label: "Build",
      description:
      ...
      ui: { view: "list" },
      instanceState: [{ field: "spec", type: "string" }],
      initialState: "specing",
      ...
      states: [
          ...
          actions: [
            {
              ...
              variant: "primary",
              completesRunningTask: true,
              // The spec must be recorded before planning: the planner is
              // grounded in it and finalizing persists it.
              gate: {
                kind: "and",
                gates: [
                  { kind: "hasRunningTask" },
                  { kind: "file", ref: "./gates/spec-recorded.ts" },
                ],
              },
          ...
          autoTransitions: [
            {
              ...
              gate: {
                kind: "and",
                gates: [
                  { kind: "taskSuccess", task: "finalizeSpec" },
                  { kind: "taskSuccess", task: "plan" },
                ],
              },
            },
          ],
        ...
        },
        {
          ...
          autoTransitions: [
            {
              to: "accepted",
              gate: { kind: "taskSuccess", task: "persistPlan" },
            },
          ],
        },
        {
    ...
    // ── buildItem: worker implements in an isolated workspace, reviewer audits ──
    {
      id: "buildItem",
      label: "Build Item",
      description:
      ...
      states: [
        ...
        },
        {
          ...
          autoTransitions: [
            {
              to: "unfulfillable",
              gate: { kind: "taskError", task: "prepareWorkspace" },
            },
            {
              to: "running",
              gate: { kind: "taskSuccess", task: "prepareWorkspace" },
            },
          ],
        },
        {
  ...
  actions: [
    {
      ...
      label: "Add ticket",
      variant: "primary",
      gate: { kind: "file", ref: "./gates/frontier-charted.ts" },
      createInstance: {
        workflowId: "ticket",
        fields: [
          {
  ...
  edges: [
    {
      ...
      // Fan out: one build-item instance per planned ticket. The planner's
      // structured output is the parsed build_plan_complete arguments; each
      // ticket object seeds the build-item's ticket field wholesale.
      fanOut: {
        task: "plan",
        path: "output.tickets",
        fields: {
          ticket: { kind: "itemPath", path: "" },
          dependsOn: { kind: "itemPath", path: "dependsOn" },
        },
      },
    },
  ],
