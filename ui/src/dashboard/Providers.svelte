  ...
  {#each groups as group, index}
    ...
    >
      <div class="worker-summary">
        <span
          class="rank-badge"
          style="background:{healthColor(group.maxScore, f.requestCount)};color:var(--bg)"
          >#{index + 1}</span
        >
        <div class="worker-identity">
          <span class="worker-name">{group.displayName}</span>
          <span class="key-badge {group.keyConfigured ? 'active' : 'no-key'}"
            >{group.keyConfigured ? "active" : "no key"}</span
          >
          {#if group.disabled}
        ...
        <div class="wmet">
          <div class="wmet-item">
            ...
            ><span class="v">{formatNumber(f.p95Latency, "ms")}</span>
          </div>
          <div class="wmet-item">
            <span class="l">Output</span
            ><span class="v">{formatNumber(f.meanTokensPerSecond)} t/s</span>
          </div>
          <div class="wmet-item">
            <span class="l">Calls</span><span class="v">{f.requestCount}</span>
          </div>
        </div>
      </div>
              ...
              <div class="mrow {isPinned ? 'pinned' : ''}">
                <div class="mrow-top">
                  ...
                  <span class="mstats">
                    <span
                      class="health-dot"
                      style="color:{healthColor(e.stabilityScore, e.requestCount)}"
                      >&#9679;</span
                    >
                ...
                {#if sub}
                  <div class="sub-bars">
                    <div class="sub-bar">
                      ...
                      ><span
                        class="sub-fill"
                        style="width:{sub.latency.toFixed(0)}%;background:{sc(sub.latency)}"
                      ></span>
                    </div>
                    <div class="sub-bar">
                      <span class="sub-label">T</span
                      ><span
                        class="sub-fill"
                        style="width:{sub.throughput.toFixed(0)}%;background:{sc(sub.throughput)}"
                      ></span>
                    </div>
                    <div class="sub-bar">
                      ...
                      ><span
                        class="sub-fill"
                        style="width:{sub.reliability.toFixed(0)}%;background:{sc(sub.reliability)}"
                      ></span>
                    </div>
                    <div class="sub-bar">
                      <span class="sub-label">Q</span
                      ><span
                        class="sub-fill"
                        style="width:{sub.quality.toFixed(0)}%;background:{sc(sub.quality)}"
                      ></span>
                    </div>
                    <div class="sub-bar">
                      ...
                      ><span
                        class="sub-fill"
                        style="width:{sub.contextWindow.toFixed(0)}%;background:{sc(sub.contextWindow)}"
                      ></span>
                    </div>
                  </div>
                {/if}
